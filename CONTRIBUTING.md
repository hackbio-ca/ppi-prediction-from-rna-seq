# Contributing to ppi-prediction-from-rna-seq

Thank you for your interest in contributing to `ppi-prediction-from-rna-seq`! We welcome contributions of all kinds, including bug fixes, feature requests, documentation improvements, and code contributions. This guide will help you get started.
...
2. **Clone your fork**: Clone your forked repository to your local development environment.
    ...
    ```bash
    git clone https://github.com/ppi-prediction-from-rna-seq/ppi-prediction-from-rna-seq.git
    ```
...
If you encounter a bug, have a question, or want to suggest a new feature, please [open an issue](https://github.com/hackbio-ca/ppi-prediction-from-rna-seq/issues) on GitHub. Provide as much detail as possible, including:
...
By contributing to `ppi-prediction-from-rna-seq`, you agree that your contributions will be licensed under the MIT License.

We appreciate your contributions and look forward to working together to improve `ppi-prediction-from-rna-seq`!
